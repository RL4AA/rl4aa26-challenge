...
This repository is an adapted and updated version of the RL4AA'25 challenge: [Zenodo](https://zenodo.org/doi/10.5281/zenodo.15120236). It builds on the previous work and changes the underlying accelerator simulation from the ARES-EA beam line at DESY, to the CLARA beam line at STFC.
