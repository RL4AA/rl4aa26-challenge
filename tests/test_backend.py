...
@pytest.mark.parametrize("section", [pytest.param(clara, marks=pytest.mark.ea)])
...
@pytest.mark.parametrize(
    "section, misalignments", [pytest.param(clara, np.zeros(8), marks=pytest.mark.ea)]
)
