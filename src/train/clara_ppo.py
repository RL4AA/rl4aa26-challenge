...
from ..environments import clara
...
def train(config: dict) -> None:
    ...
    wandb.init(
        entity="msk-ipc",
        project="rl4aa-tutorial-2026-dev",
...
def make_env(
    config: dict,
    env_class: clara.TransverseTuning,
    ...
    env = env_class(
        backend="cheetah",
        backend_args={
            "generate_screen_images": generate_screen_images,
